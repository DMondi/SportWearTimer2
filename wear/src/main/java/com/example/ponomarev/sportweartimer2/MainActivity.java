...
public class MainActivity extends Activity {
    ...
    class pauseResumeTimer implements View.OnClickListener {
     ...
     class runningTimer implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(MainActivity.this.getApplicationContext(), ConfigureTimerActivity.class);
    ...
    class clickRepeatCount implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(MainActivity.this.getApplicationContext(), ConfigureRepeatActivity.class);
